...
**WATCH THIS SPACE! VERSION 0.6.1 COMING SOON!** Featuring: plotting of estimates, a trial d prime outcome, and reliability multiverse analyses!!!

The current version of **splithalf** is 0.5.3 [unofficial version name: "Fight Milk - rebrand"]
...
Please use the following reference for the code: Parsons, S. (2019). splithalf: robust estimates of split half reliability (Version 5). figshare. https://doi.org/10.6084/m9.figshare.5559175.v5
