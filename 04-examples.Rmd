...
> We estimated the internal consitency of bias A and B using a permutation-based splithalf approach [@R-splithalf] with 5000 random splits. The splithalf internal consistency of bias A was _r_ = `r difference[1,3]`, 95%PI [`r difference[1,4]`,`r difference[1,5]`] (Spearman-Brown corrected estimates were _r_~SB~ = `r difference[1,6]`, 95%PI [`r difference[1,7]`,`r difference[1,8]`]). 
>
